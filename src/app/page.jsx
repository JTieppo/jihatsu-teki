            ...
            <section className="bg-gradient-to-r from-emerald-950 to-[#000a03]">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={"/"}
                                    className="text-2xl font-extrabold bg-white-gradient white-gradient"
                                >
                                    Jihatsu-teki
                                </Link>
                            </div>
                ...
                <section className="grid grid-cols-2 grid-rows-1 p-16 gap-16">
                    <div className="flex flex-col justify-center items-start gap-10">
                        <h1 className="text-[46px] bg-white-gradient white-gradient font-extrabold leading-[48.76px] tracking-[1.84px]">
                            TRANSFORME SUA <br />
                        ...
                        <p className="text-sm  leading-[19.6px] tracking-[1.12px]">
            ...
            <section className="bg-[#001012] p-16">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-8 items-center">
                        <p className="flex flex-row"><MagnifyingGlassIcon className="w-4 h-4 self-center mr-4" /> Procurar cidade</p>
                        <button className="border border-slate-500 px-4 p-1 rounded-lg">Ver tudo</button>
                    </div>
                </div>
